...
public:
  C_IO_Dir_Commit_Ops(CDir *d, version_t v, int pr, vector<dentry_key_t> &rm,
                      vector<CDir::dentry_commit_items> &s, vector<string> &_stale)
  ...
  void finish(int r) override {
    dir->_omap_commit_ops(r, op_prio, version, to_remove, _stale_items, to_set);
  }
